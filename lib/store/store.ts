...
class Store {
    ...
    public set<P extends SettingPath>(keyPath: P | (string & {}), value: GetValue<setting, P> | (unknown & {})): void {
    ...
    public get<P extends SettingPath>(keyPath: P | (string & {})): GetValue<setting, P> {
        const store = this.getStore();
        const pathx = keyPath.split(".");
